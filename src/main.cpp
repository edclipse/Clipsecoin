...
uint256 hashGenesisBlock("0xc1319aacd7c998ec72ebe32f1df5b1fc53ab141d188e94c64c1c7c43ae35add1");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Clipsecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Clipsecoin Signed Message:\n";
...
{
    // Clipsecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 168000); // Clipsecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 100800; // Clipsecoin: 3.5 days
static const int64 nTargetSpacing = 50; // Clipsecoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Clipsecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Clipsecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Clipsecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf9c5374f6c802639d9a81d1d6a4f9319169e27c9351137494e743f7d07020f94");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Uuu9voeHXGlQRXuPCK5MS01bHXdqxCvBChLBZvIwwHWVFDhyo9fe1M1jtbCxNWr";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("26bd5be19b1e27e678f8130fb857e1bd982a940373f93404b0e48b307a241e235d781ca9a9fcfaf9dfbbdb4a80c3997b35b4c80a1697ebeca975292b1ce49f925d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1495920137;
        block.nBits    = 504365644;
        block.nNonce   = 2189855306;

        if (fTestNet)
        {
            block.nTime    = 1495920137;
            block.nNonce   = 3189076480;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xad7d019c3aa95fb0dde7a670480f1e2b181ec3047652fae6c89949875f7ae2a8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Clipsecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ClipsecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ClipsecoinMiner : ProcessBlock, block not accepted");
    }
