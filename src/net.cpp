...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Clipsecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"clipsecoin.com", "192.187.116.242"},{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Clipsecoin is probably already running."), addrBind.ToString().c_str());
        else
